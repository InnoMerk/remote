...
#define NRF24L01_MASK_RX_DR_mask	(1<<NRF24L01_MASK_RX_DR)
#define NRF24L01_MASK_TX_DS_mask	(1<<NRF24L01_MASK_TX_DS)
#define NRF24L01_MASK_MAX_RT_mask	(1<<NRF24L01_MASK_MAX_RT)
#define NRF24L01_EN_CRC_mask			(1<<NRF24L01_EN_CRC)
#define NRF24L01_CRCO_mask				(1<<NRF24L01_CRCO)
#define NRF24L01_PWR_UP_mask			(1<<NRF24L01_PWR_UP)
#define NRF24L01_PRIM_RX_mask			1
...
/* Configuration */
#define NRF24L01_CONFIG			((NRF24L01_EN_CRC_mask)|(NRF24L01_MASK_TX_DS_mask)|(NRF24L01_MASK_MAX_RT_mask))
