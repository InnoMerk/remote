...
void NRF24L01_WriteBit(  uint8_t reg,
                                     uint8_t bit,
 									 uint8_t value);
									
uint8_t NRF24L01_ReadBit(  uint8_t reg,
                                        uint8_t bit  );
...
void NRF24L01_ReadRegisterMulti(  uint8_t reg,
                                                  uint8_t* data, 
												  uint8_t count);
												  
void NRF24L01_WriteRegisterMulti( uint8_t reg,
                                                  uint8_t *data,
												  uint8_t count);
...
void SPI_ReadMulti(  uint8_t* dataIn, 
                              uint8_t dummy,
							  uint32_t count )
{
	uint32_t i;
...
void SPI_WriteMulti( uint8_t* dataOut,
                             uint32_t count )
{
	uint32_t i;
	char cIn;
                                 ...
                                 uint8_t payload_size) 
{
	...
	NRF24L01_WriteRegister( NRF24L01_REG_RX_PW_P0,
										NRF24L01_Struct.PayloadSize); // Auto-ACK pipe
	NRF24L01_WriteRegister( NRF24L01_REG_RX_PW_P1,
                        	            NRF24L01_Struct.PayloadSize); // Data payload pipe
	...
	NRF24L01_SetRF( NRF24L01_Struct.DataRate,
         	                 NRF24L01_Struct.OutPwr);
...
void NRF24L01_GetLocalAddress( uint8_t *adr) 
{
	...
	NRF24L01_ReadRegisterMulti( NRF24L01_REG_RX_ADDR_P1,
                                              adr,
											  5);
...
void NRF24L01_SetLocalAddress(  uint8_t *adr) 
{
	...
	NRF24L01_WriteRegisterMulti(	NRF24L01_REG_RX_ADDR_P1,
												adr,
												5);
	NRF24L01_CE_HIGH();
}
...
{
	NRF24L01_WriteRegisterMulti(	NRF24L01_REG_RX_ADDR_P0,
												adr,
												5);
	NRF24L01_WriteRegisterMulti(  NRF24L01_REG_TX_ADDR,
											    adr,
											    5);
}
...
{
	NRF24L01_CE_LOW();
	NRF24L01_WriteBit(  NRF24L01_REG_CONFIG,
                                  NRF24L01_PWR_UP,
								  Bit_RESET);
}
...
void NRF24L01_SoftwareReset(void) 
{
	...
	NRF24L01_WriteRegister( NRF24L01_REG_EN_AA,
	                                    NRF24L01_REG_DEFAULT_VAL_EN_AA);
	...
	NRF24L01_WriteRegister( NRF24L01_REG_RF_CH, 		
	                                    NRF24L01_REG_DEFAULT_VAL_RF_CH);
	...
	NRF24L01_WriteRegister( NRF24L01_REG_RPD, 		
	                                    NRF24L01_REG_DEFAULT_VAL_RPD);
	...
	NRF24L01_WriteRegister( NRF24L01_REG_DYNPD, 		
	                                    NRF24L01_REG_DEFAULT_VAL_DYNPD);
